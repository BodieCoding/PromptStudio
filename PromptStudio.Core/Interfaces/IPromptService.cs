...
public interface IPromptService
{
    ...
    List<Dictionary<string, string>> ParseVariableCsv(string csvContent, List<string> expectedVariables);    /// <summary>
    ...
    Task<List<Collection>> GetCollectionsAsync();    /// <summary>
    ...
    Task<Collection?> GetCollectionByIdAsync(int id);    /// <summary>
    ...
    Task<List<PromptTemplate>> GetPromptTemplatesAsync(int? collectionId = null);    /// <summary>
    ...
    Task<PromptTemplate?> GetPromptTemplateByIdAsync(int id);    /// <summary>
    ...
    Task<object> ExecutePromptTemplateAsync(int id, string variables);    /// <summary>
    ...
    Task<int> GetTotalExecutionsCountAsync(int? promptId = null);    /// <summary>
    ...
    Task<Collection> CreateCollectionAsync(string name, string? description = null);    /// <summary>
    ...
    Task<PromptTemplate> CreatePromptTemplateAsync(string name, string content, int collectionId, string? description = null);    /// <summary>
    ...
    [McpExposed(Name = "GetVariableCollections", Description = "List variable collections for a prompt")]
    Task<List<VariableCollection>> GetVariableCollectionsAsync(int promptId);    /// <summary>
    ...
    Task<VariableCollection> CreateVariableCollectionAsync(string name, int promptId, string csvData, string? description = null);    /// <summary>
    ...
    /// <param name="overwriteExisting">A flag indicating whether to overwrite an existing collection with the same name. If false and a collection with the same name exists, a new unique name will be generated.</param>
    /// <returns>The imported (or updated/renamed) Collection object, or null if the import failed due to invalid format.</returns>
    /// <exception cref="ArgumentException">Thrown if jsonContent is invalid or essential data is missing.</exception>
    ...
    /// <returns>The updated collection, or null if not found or if a concurrency issue occurs that cannot be resolved.</returns>
    Task<Collection?> UpdateCollectionAsync(int collectionId, string name, string? description);    /// <summary>
