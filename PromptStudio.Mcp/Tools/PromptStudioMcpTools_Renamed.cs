...
[McpServerToolType]
public class PromptStudioMcpTools_Renamed
{
    private readonly IPromptService _promptService;
    private readonly ILogger<PromptStudioMcpTools_Renamed> _logger;

    public PromptStudioMcpTools_Renamed(IPromptService promptService, ILogger<PromptStudioMcpTools_Renamed> logger)
    {
    ...
    public async Task<object> CreateVariableCollection(
        ...
        [Description("Collection description")] string? description = null)
        => await InvokeExposedMethodAsync("CreateVariableCollection", name, promptId, csvData, description!);
