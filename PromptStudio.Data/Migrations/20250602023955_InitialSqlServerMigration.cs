    ...
    public partial class InitialSqlServerMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "A sample collection to get you started", "Sample Collection", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });

            migrationBuilder.InsertData(
                table: "PromptTemplates",
                columns: new[] { "Id", "CollectionId", "Content", "CreatedAt", "Description", "Name", "UpdatedAt" },
                values: new object[] { 1, 1, "Please review the following {{language}} code and provide feedback:\n\n```{{language}}\n{{code}}\n```\n\nFocus on:\n- Code quality\n- Performance\n- Security\n- Best practices", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "Review code for best practices and improvements", "Code Review", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "javascript", "Programming language of the code", "language", 1, "Text" },
                    { 2, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "// Paste your code here", "The code to review", "code", 1, "LargeText" }
                });
