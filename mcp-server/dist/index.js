...
class PromptStudioClient {
    ...
    async getPromptTemplates(collectionId) {
    ...
    async executePrompt(templateId, variables) {
    ...
    async executeBatch(promptId, collectionId) {
    ...
    async createVariableCollectionFromCsv(promptId, name, description, csvData) {
